                            ...
                            <div class="card-content">
                                <div class="content">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <input name="fileName" class="input @error('fileName') is-danger @enderror"
                                                   type="file" placeholder="The image here...">
                                        </div>
                                        @error('fileName')
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <input name="Alt" class="input @error('Alt') is-danger @enderror"
                                                   type="text" placeholder="The Alt here...">
                                        </div>
                                        @error('Alt')
                                        <p class="help is-danger">{{ $message }}</p>
                                        @enderror
